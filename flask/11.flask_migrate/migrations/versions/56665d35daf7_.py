...
Revision ID: 56665d35daf7
Revises: 1bdd017b9560
Create Date: 2020-04-22 09:12:19.002000
...
revision = '56665d35daf7'
down_revision = '1bdd017b9560'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('members', sa.Column('subscribed', sa.Boolean(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('members', sa.Column('subscribe', mysql.TINYINT(display_width=1), autoincrement=False, nullable=True))
    op.drop_column('members', 'subscribed')
